defmodule SnippetShareWeb.Layouts do
  @moduledoc """
  ...
  def app(assigns) do
    ~H"""
    <header class="flex justify-between items-center px-6 py-3 bg-base-200 h-[50px]">
      <div class="flex relative">
        <a href={~p"/"} class="mr-6">
          <div class="text-white font-bold text-3xl">Snippets</div>
        </a>
        <div>
          <input
            type="text"
